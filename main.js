...
function redirect(sessionVar){
	...
	window.location=window.location.href+"view_novel.html"
}
var novelCoverUrl;
				...
				if (snapshot.exists()) {
				  ...
				  var data=snapshot.val();
					firebase.storage().ref(data["img"]).getDownloadURL().then((url)=>{
						...
						"</h1><span class='fullcard_stat'><table><tr><th>Author</th><td>"+data["author"]+"</td></tr><tr><th>Chapters</th><td>"+data["chapter"]+"</td></tr><tr><th>Genre</th><td>"+data["genre"]+"</td></tr><tr><th>Status</th><td>"+data["stat"]+"</td></tr><tr><th>Views</th><td>"+data["views"]+"</td></tr><tr><th>Last Updated</th><td>"+usertime(data["updated"])+"</td></tr><tr><th>likes</th><td>"+data.likes+"</td></tr><tr><th>tags</th><td>"+data.tags+"</td></tr></table></span><div class='card_btn'><button id='read' class='novel_card_btn' onclick=\"setSessionVariable(this.parentElement.parentElement.querySelector('#novel_title').innerHTML.replaceAll(' ','_'),flag=true)\">&#128214;</button><button id='share' class='novel_card_btn'><i class=\"fa fa-share-alt\"></i></button><a href='"+data.patreon+"'><button id='patreon' class='novel_card_btn'><i class=\"fab fa-patreon\"></i></button></a><button id='discord' class='novel_card_btn'><i class=\"fab fa-discord\"></i></button><a href='"+data.webnovel+"'><button id='webnovel' class='novel_card_btn'></button></a></div></div>"+
						"</div></div>";
